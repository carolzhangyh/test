...
wd <- "C:/Users/carol/Desktop/stat350"
setwd(wd)
...
# Compute the sample SD's for each of the x's and y's(could have just used the sd( ) command)
...
#no compute the unit normal scaling
